...
if [ -z "$STRIPE_SECRET_KEY" ]; then
    ...
    echo ""
    echo "Usage:"
    echo "  export STRIPE_SECRET_KEY=\"YOUR_LIVE_SECRET_KEY_HERE\""
...
# Verification logic commented out for security
# Uncomment and modify as needed for your validation requirements
